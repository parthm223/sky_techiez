  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() => GetMaterialApp(
      ...
      getPages: [
        ...
        GetPage(name: '/createAccountEmail', page: () => const CreateAccountEmailScreen()),
        GetPage(name: '/createAccountMobile', page: () => const CreateAccountMobileScreen()),
        ...
        GetPage(name: '/driversLicenseCapture', page: () => const DriversLicenseCaptureScreen()),
        GetPage(name: '/editProfile', page: () => const EditProfileScreen()),
        GetPage(name: '/forgotPassword', page: () => const ForgotPasswordScreen()),
        GetPage(name: '/governmentIdCapture', page: () => const GovernmentIdCaptureScreen()),
        GetPage(name: '/homeContent', page: () => HomeContent()),
        GetPage(name: '/home', page: () => const HomeScreen()),
        GetPage(name: '/login', page: () => const LoginScreen()),
        GetPage(name: '/skyTechiezAgreement', page: () => const SkyTechiezAgreementScreen()),
        GetPage(name: '/passportCapture', page: () => const PassportCaptureScreen()),
        GetPage(name: '/privacyPolicy', page: () => const PrivacyPolicyScreen()),
        GetPage(name: '/profile', page: () => const ProfileScreen()),
        GetPage(name: '/cancellationPolicy', page: () => CancellationPolicyScreen()),
        GetPage(name: '/services', page: () => const ServicesScreen()),
        GetPage(name: '/subscriptions', page: () => const SubscriptionsScreen()),
        ...
        GetPage(name: '/verificationComplete', page: () => const VerificationCompleteScreen()),
        GetPage(name: '/welcome', page: () => const WelcomeScreen()),
        GetPage(name: '/themeSettings', page: () => const ThemeSettingsScreen()),
      ],
    ));
  }
}
