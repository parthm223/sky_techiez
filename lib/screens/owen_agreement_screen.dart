...
class _SkyTechiezAgreementScreenState extends State<SkyTechiezAgreementScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('SkyTechiez Agreement'),
        actions: [
          IconButton(
  ...
  Widget _buildPaymentPolicy() {
    return Column(
      ...
      children: [
        ...
        _buildAgreementText(
          'For information on our privacy practices, please visit www.SkyTechiez.co or call +1 (000) 000-0000.',
        ),
      ],
    );
  }
  ...
  Widget _buildDataProtectionSection() {
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 8),
        _buildAgreementText(
          'If you suspect that your SkyTechiez LLC (Application) Account or any of your security details have been compromised, or if you become aware of any fraud, attempted fraud, or any other security incident (including a cybersecurity attack) affecting you and/or SkyTechiez LLC (Application) (collectively referred to as a "Security Breach"), you must immediately notify SkyTechiez LLC (Application) Support at https://help.SkyTechiez.co or (000) 000-0000, providing accurate and up-to-date information for the duration of the Security Breach. Please take any reasonable steps we need to reduce or manage the Security Breach. Just to let you know, reporting a Security Breach does not guarantee reimbursement for any losses incurred or that SkyTechiez LLC (Application) will be liable for any losses resulting from the Security Breach.',
        ),
        const SizedBox(height: 20),
        _buildCompanyInfo(),
      ],
  ...
  void _saveAgreement() {
    // Here you would implement the logic to save the agreement
    // with the signature (_signatureController.text)
